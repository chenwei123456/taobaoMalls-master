...
<div class="w" id="logo">
    <div>
        <a href="http://taobaohbu.cn ">
            <img src="/images/taobao-logo.gif" alt="淘宝商城" width="170" height="60"/>
        </a> <b></b>
    </div>
</div>
        ...
        <form  id="personRegForm" method="post" onsubmit="return false;">
            ...
            <div class="item-new">
                ...
                <div class="fl item-ifo">
                    ...
                    <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《淘宝用户注册协议》</a></label>
                    <span class="clr"></span>
            ...
            <div class="item">
                <span class="label">&nbsp;</span>
                <input class="btn-img btn-regist" id="registsubmit" value="立即注册" tabindex="8"
